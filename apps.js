...
var fcPresets=[{c:'rgba(240,235,222,.91)',n:'暖白'},{c:'rgba(230,228,225,.88)',n:'月白'},{c:'rgba(210,208,205,.82)',n:'浅灰'},{c:'rgba(190,188,185,.75)',n:'中灰'},{c:'rgba(255,255,255,.92)',n:'纯白'},{c:'rgba(245,240,230,.9)',n:'象牙'},{c:'rgba(220,215,200,.85)',n:'宣纸'},{c:'rgba(200,195,180,.8)',n:'麻色'},{c:'rgba(180,175,165,.75)',n:'烟灰'},{c:'rgba(160,155,148,.65)',n:'青灰'}];
