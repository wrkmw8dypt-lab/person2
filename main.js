...
return'<div class="rp"><details><summary><div class="rp-h"><div class="rp-hl"><div class="dot dg"></div><span class="rp-ttl">个人面板</span></div><span class="rp-arr">▾</span></div></summary><div class="rp-bd"><div class="pf-top"><div class="pf-img" onclick="document.getElementById(\''+id+'\').click()"><img id="'+id+'-i" src="" style="display:none"><div id="'+id+'-p" class="pf-ph"><span class="pf-pht">点击<br>导入立绘</span></div></div><input type="file" accept="image/*" style="display:none" id="'+id+'" data-av="__USER__"><div class="pf-info"><div class="attr-rk">[ '+esc(rank)+' ] '+esc(title)+'</div></div></div>'+(comment?'<div class="attr-cm">'+esc(comment)+'</div>':'')+'<div style="height:1px;background:rgba(255,255,255,.05);margin:8px 0"></div>'+(equipH?'<div class="equip-section"><div class="pf-section-title">装备</div><div class="equip-zone">'+equipH+'</div></div>':'')+'<div class="pf-section-title">属性</div><div class="attr-grid">'+attrH+'</div></div></details></div>';}
